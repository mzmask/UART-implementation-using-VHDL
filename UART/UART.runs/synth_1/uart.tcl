...
set_property webtalk.parent_dir D:/jobs/rastafan/UART-implementation-using-VHDL/UART/UART.cache/wt [current_project]
...
read_vhdl -library xil_defaultlib D:/jobs/rastafan/UART-implementation-using-VHDL/UART/UART.srcs/sources_1/new/uart.vhd
read_ip -quiet d:/jobs/rastafan/UART-implementation-using-VHDL/UART/UART.srcs/sources_1/ip/CDC_FIFO/CDC_FIFO.xci
set_property used_in_implementation false [get_files -all d:/jobs/rastafan/UART-implementation-using-VHDL/UART/UART.srcs/sources_1/ip/CDC_FIFO/CDC_FIFO.xdc]
set_property used_in_implementation false [get_files -all d:/jobs/rastafan/UART-implementation-using-VHDL/UART/UART.srcs/sources_1/ip/CDC_FIFO/CDC_FIFO_clocks.xdc]
set_property used_in_implementation false [get_files -all d:/jobs/rastafan/UART-implementation-using-VHDL/UART/UART.srcs/sources_1/ip/CDC_FIFO/CDC_FIFO_ooc.xdc]
...
synth_design -top uart -part xc7k70tfbg484-3
