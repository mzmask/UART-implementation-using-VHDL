...
// Command     : write_verilog -force -mode synth_stub -rename_top CDC_FIFO -prefix
//               CDC_FIFO_ CDC_FIFO_stub.v
// Design      : CDC_FIFO
...
module CDC_FIFO(rst, wr_clk, rd_clk, din, wr_en, rd_en, dout, full, 
  empty, valid)
